...
else if (noiseChoice == "YES")
{
    ...
    string doorOpeningChoice = Console.ReadLine()!;
    doorOpeningChoice = doorOpeningChoice.ToUpper();

    if (doorOpeningChoice == "KNOCK")
    {
    ...
    else if (doorOpeningChoice == "OPEN")
    {
        ...
        switch (keyChoice)
        {
            ...
            case "3":
                ...
                break;
            default:
                Console.WriteLine("That was not one of the options specified");
                Console.WriteLine("THE END");
                break;
        }
    }
